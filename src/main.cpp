...
TEST_F(M6502Test, CPUDoesNothingWhenExecutedWithZeroCycles){
    //given:
...
TEST_F(M6502Test, LDAImmediateCanLoadAValueIntoARegister){
    //given:
    mem[0xFFFC] = CPU::INS_LDA_IM;
    mem[0xFFFD] = 0x84;
    CPU CPUCopy = cpu;
...
TEST_F(M6502Test, LDASetZAndNFlags){
    //given:
...
TEST_F(M6502Test, LDAZeroPageCanLoadAValueIntoARegister){
    //given:
...
TEST_F(M6502Test, LDAZeroPageXCanLoadAValueIntoARegister){
    //given:
    cpu.X = 5;
...
TEST_F(M6502Test, LDAZeroPageXCanLoadAValueIntoARegisterWhenItWraps){
    //given:
    cpu.X = 0xFF;
...
TEST_F(M6502Test, LDAAbsolutCanLoadAValueIntoARegister){
    //given:
...
TEST_F(M6502Test, LDAAbsolutXCanLoadAValueIntoARegister){
    //given:
    constexpr int32_t NUM_CYCLES = 4;
...
TEST_F(M6502Test, LDAAbsolutXCanLoadAValueIntoARegisterWhenItCrossesPageBoundry){
    //given:
...
TEST_F(M6502Test, LDAAbsolutYCanLoadAValueIntoARegister){
    //given:
    constexpr int32_t NUM_CYCLES = 4;
...
TEST_F(M6502Test, LDAAbsolutYCanLoadAValueIntoARegisterWhenItCrossesPageBoundary){
    //given:
    constexpr int32_t NUM_CYCLES = 5;
...
TEST_F(M6502Test, LDAIndirectXCanLoadAValueIntoARegister){
    //given:
...
TEST_F(M6502Test, LDAIndirectYCanLoadAValueIntoARegister){
    //given:
    constexpr int32_t NUM_CYCLES = 5;
...
TEST_F(M6502Test, LDAIndirectYCanLoadAValueIntoARegisterWhenItCrossesPageBoundary){
    //given:
    constexpr int32_t NUM_CYCLES = 6;
