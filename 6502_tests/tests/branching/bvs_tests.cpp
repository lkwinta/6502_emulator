...
class M6502BVSTest : public testing::Test {
public:
    Memory mem{};
    CPU cpu;
...
TEST_F(M6502BVSTest, BVSUnsuccessfulBranch){
    //given:

    cpu.P.V = 0;
    mem[0x8000] = INSTRUCTIONS::INS_BVS; //2 cycles (branch unsuccessful)
    mem[0x8001] = 0x1;
...
TEST_F(M6502BVSTest, BVSCanBranchForward){
    //given:

    cpu.P.V = 1;
    mem[0x8000] = INSTRUCTIONS::INS_BVS; //3 cycles (branch successful, same page)
    mem[0x8001] = 0x1;
...
TEST_F(M6502BVSTest, BVSCanBranchForwardToNextPage){
    //given:
...
TEST_F(M6502BVSTest, BVSCanBranchBackward){
    //given:
    ...
    mem[0x8001] = 0xF0;
    mem[0x8002] = 0x80;
    mem[0x80F0] = INSTRUCTIONS::INS_BVS; //3 cycles (branch successful, same page)
...
TEST_F(M6502BVSTest, BVSCanBranchBackwardToNextPage){
    //given:
