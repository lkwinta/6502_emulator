...
TEST_F(ORATest, ANDImmediate){
    //given:
    cpu.A = bin1;
    mem[0x8000] = CPU::INSTRUCTIONS::INS_ORA_IM;
    mem[0x8001] = bin2;
    CPU CPUCopy = cpu;
...
TEST_F(ORATest, ANDZeroPage){
    //given:
    cpu.A = bin1;
    mem[0x8000] = CPU::INSTRUCTIONS::INS_ORA_ZP;
    mem[0x8001] = 0x23;
    mem[0x0023] = bin2;
    CPU CPUCopy = cpu;
...
TEST_F(ORATest, ANDZeroPageX){
    ...
    cpu.A = bin1;
    cpu.X = 0x21;
    mem[0x8000] = CPU::INSTRUCTIONS::INS_ORA_ZP_X;
    mem[0x8001] = 0x23;
    mem[0x0044] = bin2;
    CPU CPUCopy = cpu;
...
TEST_F(ORATest, ANDAbsolute){
    //given:
    cpu.A = bin1;
    mem[0x8000] = CPU::INSTRUCTIONS::INS_ORA_ABS;
    mem[0x8001] = 0x23;
...
TEST_F(ORATest, ANDAbsoluteX){
    ...
    cpu.A = bin1;
    cpu.X = 0x24;
    mem[0x8000] = CPU::INSTRUCTIONS::INS_ORA_ABS_X;
    mem[0x8001] = 0x23;
...
TEST_F(ORATest, ANDAbsoluteY){
    ...
    cpu.A = bin1;
    cpu.Y = 0x24;
    mem[0x8000] = CPU::INSTRUCTIONS::INS_ORA_ABS_Y;
    mem[0x8001] = 0x23;
    mem[0x8002] = 0x24;// 0x2423 + 0x24
    mem[0x2447] = bin2;
    CPU CPUCopy = cpu;
...
TEST_F(ORATest, ANDAIndirectX){
    ...
    cpu.A = bin1;
    cpu.X = 0x24;
    mem[0x8000] = CPU::INSTRUCTIONS::INS_ORA_IND_X;
    mem[0x8001] = 0x23;
...
TEST_F(ORATest, ANDIndirectY){
    ...
    mem[0x8000] = CPU::INSTRUCTIONS::INS_ORA_IND_Y;
    mem[0x8001] = 0x23;
    mem[0x0023] = 0x23;
