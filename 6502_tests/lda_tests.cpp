...
TEST_F(M6502LDATest, LDAZeroPageCanLoadAValueIntoARegister){
    //given:
    mem[0xFFFC] = CPU::INSTRUCTIONS::INS_LDA_ZP;
    mem[0xFFFD] = 0x42;
    mem[0x0042] = 0x37;
    CPU CPUCopy = cpu;
...
TEST_F(M6502LDATest, LDAZeroPageXCanLoadAValueIntoARegister){
    ...
    mem[0xFFFC] = CPU::INSTRUCTIONS::INS_LDA_ZP_X;
    mem[0xFFFD] = 0x42;
    mem[0x0047] = 0x37;
...
TEST_F(M6502LDATest, LDAAbsolutCanLoadAValueIntoARegister){
    ...
    mem[0xFFFC] = CPU::INSTRUCTIONS::INS_LDA_ABS;
    mem[0xFFFD] = 0x80;
...
TEST_F(M6502LDATest, LDAAbsolutXCanLoadAValueIntoARegister){
    ...
    cpu.X = 0x40;
    mem[0xFFFC] = CPU::INSTRUCTIONS::INS_LDA_ABS_X;
    mem[0xFFFD] = 0x80;
    mem[0xFFFE] = 0x44; //0x4480
...
TEST_F(M6502LDATest, LDAAbsolutYCanLoadAValueIntoARegister){
    ...
    cpu.Y = 0x40;
    mem[0xFFFC] = CPU::INSTRUCTIONS::INS_LDA_ABS_Y;
    mem[0xFFFD] = 0x80;
    mem[0xFFFE] = 0x44; //0x4480
    mem[0x44C0] = 0x37; //0x4480 + 0x0040 = 0x44C0
...
TEST_F(M6502LDATest, LDAIndirectXCanLoadAValueIntoARegister){
    ...
    cpu.X = 0x04;
    mem[0xFFFC] = CPU::INSTRUCTIONS::INS_LDA_IND_X;
    mem[0xFFFD] = 0x02;
...
TEST_F(M6502LDATest, LDAIndirectYCanLoadAValueIntoARegister){
    ...
    cpu.Y = 0x04;
    mem[0xFFFC] = CPU::INSTRUCTIONS::INS_LDA_IND_Y;
    mem[0xFFFD] = 0x02;
    mem[0x0002] = 0x00;
